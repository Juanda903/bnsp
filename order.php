...
<body>
    <div class="container">
        ...
        <form action="" method="POST">
            ...
            <input type="checkbox" name="termasuk_sarapan" id="termasuk_breakfast" onchange="updateTotal()"><br>
...
function updateTotal() {
    ...
    const termasukSarapan = document.getElementById('termasuk_breakfast').checked;
